...
Create and submit inquiries addressed to a specific department
Track the status of submitted inquiries (e.g., Pending, In Progress, Resolved)
Receive and view responses from departments
View inquiry history

 Department

View all inquiries directed to their department
Respond to student inquiries
Update inquiry status (e.g., mark as Resolved)
Manage their department's inquiry queue

 Admin

Monitor all inquiries across all departments
View inquiry statistics and activity logs
Manage user accounts (students and department staff)
Reassign inquiries to different departments if needed
...
Student submits inquiry
        │
        ▼
Inquiry routed to selected Department
        │
        ▼
Department reviews and responds
        │
        ▼
Student receives notification & views response
        │
        ▼
Inquiry marked as Resolved
        │
        ▼
Admin monitors entire process via dashboard
